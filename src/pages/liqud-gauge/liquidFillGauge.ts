...
* I upgraded the D3 API to V4 and made minor modifications along the way as I converted it to Typescript from Javascript.
...
export function liquidFillGaugeDefaultSettings() {
  return {
    ...
    waveAnimateTime: 500, // The amount of time in milliseconds for a full wave to enter the wave circle.
